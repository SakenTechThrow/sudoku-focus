  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white/90 text-cyan-700 shadow-[0_10px_24px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-slate-950/60 dark:text-cyan-200 dark:shadow-none">
