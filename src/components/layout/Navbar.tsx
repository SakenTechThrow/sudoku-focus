    ...
    <header className="sticky top-0 z-30 border-b border-slate-900/10 bg-white/72 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/70">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:px-8 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex items-center justify-between gap-4">
          <Link
            to="/"
            className="flex items-center gap-3 rounded-full border border-slate-900/10 bg-white/75 px-4 py-2 text-left shadow-[0_12px_40px_rgba(15,23,42,0.10)] transition hover:border-cyan-300/30 hover:bg-white/90 dark:border-white/10 dark:bg-white/5 dark:shadow-[0_12px_40px_rgba(3,7,18,0.28)] dark:hover:bg-white/8"
          >
            ...
            <span>
              ...
              <span className="block text-xs text-slate-500 dark:text-slate-400">
                Daily brain training for busy minds
              </span>
            </span>
          </Link>
